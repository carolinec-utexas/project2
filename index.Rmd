...
Discussion: The MSE for the overall dataset is 270.4508, which is very high. The average MSE across the k testing folds was 287.0851, which is even higher and indicates that there is overfitting. (Since the MSE is higher in the CV, this indicates that there is likely overfitting.)
