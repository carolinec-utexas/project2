...
#infectious_disease <- "Malaria"

```

```{python}
# python code here
#infectious_disease <- "vector-borne pathogen"
#print(r.infectious_disease, infectious_disease)

```

```{R}
#R code chunk
#cat(c(infectious_disease,py$infectious_disease))
